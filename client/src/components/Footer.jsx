export default function Example() {
    return (
        <footer className="relative overflow-hidden border px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    <div className="flex items-center"> 
                        ...
                        <h2 className="text-primary text-3xl font-semibold">Quick.ai</h2>
                    </div>
