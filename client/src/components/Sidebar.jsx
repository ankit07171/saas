...
const navItems = [
  ...
  { to: "/ai/text-overlay", label: "Text-Overlay", Icon: FileTypeCorner },
];
...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <aside
      ...
      max-sm:fixed top-14 bottom-0 z-40
    ...
    >
      ...
      {/* Navigation */}
      <nav className="px-4 flex-1 text-sm text-gray-600 font-medium space-y-1">
